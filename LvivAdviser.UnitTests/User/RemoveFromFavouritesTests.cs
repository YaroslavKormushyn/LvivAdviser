...
{
	[TestClass]
	public class RemoveFromFavouritesTests
	{
		...
		[TestMethod]
		public void RemoveNonExistentFromFavourites()
		{
			...
			var actionResult = userController.RemoveFromFavourites(contentToFavourite.Id);
		...
		[TestMethod]
		public void RemoveNotFavouritedFromFavourites()
		{
			var contentToFavourite = new Content
			{
				Id = 1
		...
		[TestMethod]
		public void RemoveFavouritedFromFavourites()
		{
			var contentToFavourite = new Content
			{
				Id = 1
			...
			Assert.AreEqual(0, favourited.Count);
